                ...
                <div class="row justify-content-center" style="margin-top: 100px;">
                    ...
                    <div class="col-md-7 col-lg-5">
                        <div class="login-wrap p-4 p-md-5">
                            ...
                            <!-- Input username -->
                            <div class="form-group">
                                <label for="" style="margin-bottom: 5px;">Email&nbsp;</label><label for=""
    ...
    <script>
        ...
        function register() {
            ...
            if (username != "" && password != "" && email != "") {
                    ...
                    if (username.length >= 5 && username.length <= 30) {
                        if (password.length >= 5 && password.length <= 30) {
                            ...
                            if (specialChars.test(username) == false) {
                                ...
                                document.getElementById("regError").innerText = "Username must not contain special characters!";
                                return false;
                            }
                        } else {
                ...
                document.getElementById("regError").innerText = "Please fill in your email, username and password!";
                return false;
            }
        }
    </script>
